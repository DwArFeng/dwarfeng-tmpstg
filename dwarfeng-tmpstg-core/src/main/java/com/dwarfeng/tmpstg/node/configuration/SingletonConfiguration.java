...
public class SingletonConfiguration {
    ...
    public static final String SPEL_TEMPORARY_FILE_PREFIX = "${tmpstg.temporary_file_prefix:" +
            "#{T(com.dwarfeng.tmpstg.stack.struct.TemporaryStorageConfig$Builder).DEFAULT_TEMPORARY_FILE_PREFIX}}";
    ...
    public static final String SPEL_TEMPORARY_FILE_SUFFIX = "${tmpstg.temporary_file_suffix:" +
            "#{T(com.dwarfeng.tmpstg.stack.struct.TemporaryStorageConfig$Builder).DEFAULT_TEMPORARY_FILE_SUFFIX}}";
    ...
    public static final String SPEL_MAX_BUFFER_SIZE_TOTAL = "${tmpstg.max_buffer_size_total:" +
            "#{T(com.dwarfeng.tmpstg.stack.struct.TemporaryStorageConfig$Builder).DEFAULT_MAX_BUFFER_SIZE_TOTAL}}";
    ...
    public static final String SPEL_CLEAR_DISPOSED_INTERVAL = "${tmpstg.clear_disposed_interval:" +
            "#{T(com.dwarfeng.tmpstg.stack.struct.TemporaryStorageConfig$Builder).DEFAULT_CLEAR_DISPOSED_INTERVAL}}";
    ...
    public static final String SPEL_CHECK_MEMORY_INTERVAL = "${tmpstg.check_memory_interval:" +
            "#{T(com.dwarfeng.tmpstg.stack.struct.TemporaryStorageConfig$Builder).DEFAULT_CHECK_MEMORY_INTERVAL}}";
